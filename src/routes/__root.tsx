  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/gm8FIh4ueiXEknuMNcxksFnxalA3/social-images/social-1783530470390-ChatGPT_Image_Jul_8,_2026,_08_22_00_PM.webp",
      },
      {
        name: "twitter:image",
        content:
